...
```{r}
main<- read.csv("~/Conicet 2017/Ms_capitulo3/Rcode/data/interaction_matrix.csv",header=T,sep=",",dec=".",na.strings="NA")
str(main)
```
...
```{r null models, echo=TRUE, message= TRUE, warning= TRUE}

#Grazed sites
nullmodel(wG,N= 1000, method= "r2d")

#Ungrazed sites
nullmodel(wUG,N= 1000, method= "r2d")
