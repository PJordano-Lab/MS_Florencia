...
write.csv(splevelG,"splevelGl.csv")


splevelUG<-specieslevel(wUG, level= "higher") # This gives you a lot of parameters
# for each species and each Prosopis tree
splevelUG
...
```
##Grazed network: P value for modularity M=  0.5175455 
##zeta=   57.90098 P=   0e+00 

##Ungrazed network: P value for modularity M=  0.4083825 
