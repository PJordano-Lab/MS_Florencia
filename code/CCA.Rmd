...
I am setting a strict threshold of `thresh= 5`; if I relax the value to `thresh= 10` then variable `Veg_pot` would be added to the final model. Finally we use `thresh= 10`.
